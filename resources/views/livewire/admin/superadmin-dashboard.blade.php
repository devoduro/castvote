<div>
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:20px;flex-wrap:wrap">
        ...
        <div style="display:flex;gap:9px;flex-wrap:wrap;align-items:center">
            ...
            <a href="{{ route('admin.approvals') }}"
               ...
               onmouseover="this.style.borderColor='#e11d74';this.style.color='#e11d74'" onmouseout="this.style.borderColor='#e2e8f0';this.style.color='#475569'">
            ...
            <a href="{{ route('admin.audit') }}"
               style="display:inline-flex;align-items:center;gap:6px;background:#e11d74;color:white;border-radius:9px;padding:8px 14px;font-size:12.5px;font-weight:700;text-decoration:none;box-shadow:0 4px 12px rgba(225,29,116,.28)">
    ...
    @php
        $kpis = [
            ['label'=>'Platform Revenue', 'value'=>'GHS '.number_format($platformRevenue/100,2), 'sub'=>'Total collected',    'bg'=>'#e11d74','shadow'=>'rgba(225,29,116,.25)',  'path'=>'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
            ...
            ['label'=>'Organizations',    'value'=>$totalOrgs,                                   'sub'=>'Registered',         'bg'=>'#dc6803','shadow'=>'rgba(220,104,3,.25)', 'path'=>'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
            ['label'=>'Total Events',     'value'=>$totalEvents,                                 'sub'=>'All time',           'bg'=>'#6f4497','shadow'=>'rgba(111,68,151,.25)', 'path'=>'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
            ...
            ['label'=>'Total Votes',      'value'=>number_format($totalVotes),                   'sub'=>'Platform-wide',      'bg'=>'#e11d74','shadow'=>'rgba(225,29,116,.25)',  'path'=>'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'],
        ];
    @endphp
    ...
    <div style="display:grid;grid-template-columns:1fr 308px;gap:18px;margin-bottom:18px">
        ...
        <div style="background:white;border-radius:14px;border:1px solid #e8eaf0;box-shadow:0 2px 8px rgba(0,0,0,.04);overflow:hidden">
            <div style="padding:14px 18px;border-bottom:1px solid #faf9fc;display:flex;align-items:center;justify-content:space-between;gap:12px">
                <div>
                ...
                <a href="{{ route('admin.approvals') }}"
                   style="display:inline-flex;align-items:center;gap:5px;font-size:12px;font-weight:700;color:#e11d74;text-decoration:none;background:rgba(225,29,116,.08);padding:6px 12px;border-radius:7px"
                   onmouseover="this.style.background='rgba(225,29,116,.14)'" onmouseout="this.style.background='rgba(225,29,116,.08)'">
            ...
            <div style="overflow-x:auto">
                <table style="width:100%;border-collapse:collapse">
                    <thead>
                        <tr style="background:#f8fafc;border-bottom:1px solid #faf9fc">
                        ...
                        <tr style="border-top:1px solid #f5f7fa;transition:background .1s" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background=''">
                            <td style="padding:11px 16px">
                                <div style="display:flex;align-items:center;gap:9px">
                                    <div style="width:30px;height:30px;border-radius:8px;background:#e11d74;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:10.5px;font-weight:800;color:white;letter-spacing:-.5px">
                            ...
                            <td style="padding:11px 16px;min-width:110px">
                                ...
                                <div style="height:3px;border-radius:3px;background:#faf9fc;overflow:hidden">
        ...
        <div style="display:flex;flex-direction:column;gap:14px">
            ...
            <div style="background:white;border-radius:14px;border:1px solid #e8eaf0;box-shadow:0 2px 8px rgba(0,0,0,.04);padding:16px">
                <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:14px">
                    ...
                    <div style="background:rgba(225,29,116,.08);border-radius:8px;padding:6px 10px;text-align:center">
                        <p style="font-size:10px;font-weight:700;color:#e11d74;margin-bottom:1px">FEE</p>
                        <p style="font-size:13px;font-weight:900;color:#e11d74">GHS {{ number_format($platformFee/100,2) }}</p>
                    </div>
                </div>
                ...
                <div style="display:flex;align-items:flex-end;gap:2px;height:72px;border-radius:9px;overflow:hidden;background:#f8fafc;padding:8px 8px 0">
                    ...
                    <div style="flex:1;border-radius:2px 2px 0 0;background:linear-gradient(180deg,#e11d74,#6f4497);min-height:2px;height:{{ max(2, round($day->total/$maxRev*58)) }}px;transition:height .3s;cursor:default"
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:12px;padding-top:12px;border-top:1px solid #faf9fc">
                    <div style="background:rgba(111,68,151,.07);border-radius:8px;padding:9px 10px">
                        <p style="font-size:9.5px;font-weight:700;color:#6f4497;letter-spacing:.06em;margin-bottom:3px">TOTAL ADMINS</p>
                        <p style="font-size:16px;font-weight:900;color:#6f4497">{{ $totalAdmins }}</p>
                    </div>
                    <div style="background:rgba(220,104,3,.07);border-radius:8px;padding:9px 10px">
                        <p style="font-size:9.5px;font-weight:700;color:#dc6803;letter-spacing:.06em;margin-bottom:3px">TOTAL ORGS</p>
                        <p style="font-size:16px;font-weight:900;color:#dc6803">{{ $totalOrgs }}</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background:white;border-radius:14px;border:1px solid #e8eaf0;box-shadow:0 2px 8px rgba(0,0,0,.04);overflow:hidden;flex:1">
                <div style="padding:12px 16px;border-bottom:1px solid #faf9fc;display:flex;align-items:center;justify-content:space-between">
                    <h3 style="font-size:13px;font-weight:800;color:#1e293b">Recent Signups</h3>
                    <a href="{{ route('admin.approvals') }}" style="font-size:11.5px;font-weight:700;color:#e11d74;text-decoration:none">View all →</a>
                </div>
                @forelse($recentOrgs as $org)
                @php
                    $sc=['approved'=>['#dcfce7','#059669'],'pending'=>['#fef3c7','#d97706'],'rejected'=>['#fee2e2','#dc2626']];
                    [$sbg,$stc]=$sc[$org->account_status]??['#f3f4f6','#6b7280'];
                    $avatarColors=['#e11d74','#22c55e','#dc6803','#6f4497','#0ea5e9'];
    ...
    <div style="background:white;border-radius:14px;border:1px solid #e8eaf0;box-shadow:0 2px 8px rgba(0,0,0,.04);overflow:hidden">
        <div style="padding:14px 20px;border-bottom:1px solid #faf9fc;display:flex;align-items:center;justify-content:space-between">
            <div>
        ...
        @php
            $actionMeta = [
                ...
                'event'     => ['rgba(111,68,151,.12)','#6f4497','bg-purple'],
                'payment'   => ['#d1fae5','#059669','bg-green'],
                'organizer' => ['#fef3c7','#d97706','bg-yellow'],
                'vote'      => ['rgba(225,29,116,.1)','#e11d74','bg-indigo'],
                'password'  => ['#fee2e2','#dc2626','bg-red'],
                'profile'   => ['#e0f2fe','#0369a1','bg-cyan'],
            ];
            $dotColors = ['account'=>'#3b82f6','event'=>'#6f4497','payment'=>'#22c55e','organizer'=>'#f59e0b','vote'=>'#e11d74','password'=>'#ef4444','profile'=>'#0ea5e9'];
        @endphp
