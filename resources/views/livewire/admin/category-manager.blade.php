<div>
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px">
        <div>
            <h3 style="font-size:17px;font-weight:800;color:#241038">Categories</h3>
    ...
    <div style="background:#fff1f7;border:1.5px solid #fecce0;border-radius:14px;padding:20px;margin-bottom:20px">
        <h4 style="font-weight:700;color:#241038;font-size:14px;margin-bottom:14px">{{ $editingId ? 'Edit Category' : 'New Category' }}</h4>
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f9fafb" onmouseover="this.style.background='#fafafa'" onmouseout="this.style.background=''">
                    <td style="padding:14px 20px">
                        <span style="background:#f7f5fb;color:#6f4497;padding:3px 10px;border-radius:8px;font-family:monospace;font-size:13px;font-weight:800">{{ $cat->code }}</span>
                    </td>
                    <td style="padding:14px 20px;font-weight:600;color:#241038;font-size:14px">{{ $cat->name }}</td>
                    ...
                    <td style="padding:14px 20px;text-align:right">
                        <div style="display:flex;gap:10px;align-items:center;justify-content:flex-end">
                            <a href="{{ route('admin.events.nominees', [$event, $cat]) }}"
                               style="font-size:12.5px;font-weight:600;color:#6f4497;text-decoration:none">Nominees</a>
